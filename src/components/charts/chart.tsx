...
import type { WeightEntry } from "../../service";
...
export function RecentEntries({ entries }: RecentEntriesProps) {
  ...
  return (
    <section className="h-full bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 p-5">
          ...
          {sorted.map((entry) => (
            ...
            >
              <div className="flex flex-col">
                ...
                {entry.note && (
                  <span className="text-xs text-slate-600 dark:text-slate-500 mt-0.5 truncate max-w-45">
                    {entry.note}
                  </span>
                )}
              </div>
...
export default function Chart({ entries }: ChartProps) {
  ...
  return (
    <section className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 p-5 text-slate-600 dark:text-slate-300">
